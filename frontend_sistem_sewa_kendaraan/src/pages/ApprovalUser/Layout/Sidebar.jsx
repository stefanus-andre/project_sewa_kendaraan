...
import { Home, Settings, LogOut, Menu, X, FileCheck, Check } from "lucide-react"
...
export default function Sidebar({ children }) {
    ...
    const adminMenuItems = [
        ...
        { label: "Data Booking", icon: Home, href: "/admin/data_booking" },
        { label: "Data Kendaraan", icon: Home, href: "/admin/data_kendaraan" },
        { label: "Data Region", icon: Home, href: "/admin/data_region" },
